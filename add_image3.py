...
def extract_features_from_db2(db_path):
    conn = sqlite3.connect(db_path)
    cursor = conn.cursor()
...
def main():
    ...
    db_path2 = './Ryugu_Data/Ryugu_CLAHE/database3.db'
    # db_path2 = './Ryugu_Data/Ryugu_CLAHE/database4.db'
    
    input_dir = './Ryugu_Data/Ryugu_CLAHE/Input3'
    # input_dir = './Ryugu_Data/Ryugu_CLAHE/Input2test'
    # input_dir = './Ryugu_Data/Ryugu_CLAHE/Input4'
