...
def setup_cfg():
    ...
    cfg.MODEL.ROI_HEADS.SCORE_THRESH_TEST = 0.005 # スコア閾値を設定（必要に応じて調整）
...
if __name__ == "__main__":
    ...
    input_directory = "./Ryugu_Data/Ryugu_pole2/Input"
    output_directory = "./Ryugu_Data/Ryugu_pole2/Input2"
